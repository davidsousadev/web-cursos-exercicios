...
def corrida(metros):
    deslocamnetoLebre = 0
    deslocamentoTartaruga = 0
    while metros > deslocamnetoLebre:
        deslocamnetoLebre += 9 
        deslocamentoTartaruga += 1
    return deslocamentoTartaruga




def main():
    metros = int(input("Digitea quantidade em metros: "))
    minutos = corrida(metros)
    print(f"A tartaruga sair {metros} metros à frente a lebre alcança em {minutos} minutos.")
